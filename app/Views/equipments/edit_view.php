<header class="text-center py-4">
    <h1 class="mb-0">Edit Equipment</h1>
</header>
<main>
            ...
            <div class="card-body">
                <form action="<?= base_url('equipments/update/'.$equipment['equipment_id']); ?>" method="post" enctype="multipart/form-data">
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <?php if (!empty($equipment['image'])): ?>
                                <img src="<?= base_url('public/assets/images/products/' . $equipment['image']); ?>" alt="<?= $equipment['name']; ?>" class="img-fluid rounded" style="max-height: 150px;">
                            <?php else: ?>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="description" name="description" value="<?= $equipment['description'];?>" required>
                        </div>
                    </div>
